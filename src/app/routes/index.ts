...
import { AgentCommissionHistoryRoutes } from "../modules/transaction/agentCommissionHistory/agentCommissionHistory.route";
...
const moduleRoutes = [
  ...
  { path: "/agent-commission", route: AgentCommissionHistoryRoutes },
];
